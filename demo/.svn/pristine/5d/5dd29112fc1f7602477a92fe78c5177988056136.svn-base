...
public:
	...
	KSRESULT Attach(HMODULE hModule);
	HMODULE Detach(void);
private:
...
{
	if (NULL == m_pfnDllGetClassObject)
	{
		return E_FAIL;
	}
...
inline KSRESULT KSDll::Attach(HMODULE hModule)
{
	Release();
	m_hModule = hModule;
