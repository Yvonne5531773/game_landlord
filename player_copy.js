...
var player = {
    ...
    onInquirePlayerCallLandlord: function() {
        ...
        // TODO: 实现逻辑
        return new CallLandlordReply(MsgResultCallLandlordYes, 3);
    },
    ...
    onInquirePlayCards: function() {
        ...
        // TODO: 实现逻辑
        return new PlayResult(MsgResultPlayCardsYes, [{point: 13, style: 2}]);
    },
    ...
    onResultOfPlayCards: function(position, result, cards) {
        console.log('in onResultOfPlayCards position',position)
        console.log('in onResultOfPlayCards result',result)
        console.log('in onResultOfPlayCards cards',cards)
...
http.createServer(function(req, res) {
    ...
    if (fun_name == "Init") {
        ...
        console.log('ResultOfPlayCards ResultOfPlayCards data',data)
        if (data) {
